...
import rec1 from "../../assets/3.png";
import rec2 from "../../assets/4.png";
import rec3 from "../../assets/5.png";
import rec4 from "../../assets/6.png";
import rec5 from "../../assets/7.png";
import rec6 from "../../assets/8.png";
import rec7 from "../../assets/9.png";
import u1 from "../../assets/user.png";
import u2 from "../../assets/user.png";
import u3 from "../../assets/user.png";
import u4 from "../../assets/user.png";
import searchicon from "../../assets/search.png";
import groupicon from "../../assets/add.png";
import menuicon from "../../assets/menu.png";
import shareicon from "../../assets/share.png";
import editicon from "../../assets/edit.png";
import calendericon from "../../assets/calender.png";
import jobicon from "../../assets/cart.png";
import locationicon from "../../assets/location.png";
import infoicon from "../../assets/details.png";
import closeicon from "../../assets/cross.png";
import likeicon from "../../assets/cross.png";
import leaveicon from "../../assets/fwd.png";
import modalcloseicon from "../../assets/crosss.png";
import canvascloseicon from "../../assets/crosss.png";
    ...
    <div>
      ...
      <div style={{ backgroundColor: "black" }}>
        <img
          ...
          style={{
            width: "100%",
            height: breaking_point_desktop
              ? "440px"
              : breaking_point_mobile
              ? "300px"
              : "200px",
            marginTop: breaking_point_desktop ? "72px" : "",
            opacity: "0.5",
          }}
        />
        <h2
          className="celabel"
          style={{
            fontSize: breaking_point_mobile ? "" : "18px",
            fontWeight: "700",
            color: "white",
            position: "absolute",
            marginTop: breaking_point_desktop
              ? "-150px"
              : breaking_point_mobile
              ? "-100px"
              : "-70px",
        ...
        <p
          className="celabel2"
          style={{
            fontSize: breaking_point_mobile ? "" : "12px",
            color: "white",
            position: "absolute",
            marginTop: breaking_point_desktop
              ? "-110px"
        ...
        {!breaking_point_desktop && (
          <>
            <p>
              <img
                ...
                style={{
                  cursor: "pointer",
                  position: "absolute",
                  marginTop: breaking_point_mobile ? "-275px" : "-183px",
                  marginLeft: "3.75%",
                }}
              />
            </p>
            {user_signed_in ? (
              <button
                onClick={() => setUser_signed_in(false)}
                style={{
                  position: "absolute",
                  borderColor: "white",
                  color: "white",
                  borderRadius: "4px",
                  marginTop: breaking_point_mobile ? "-298px" : "-205px",
                  right: "0",
                  marginRight: "3.75%",
                }}
                class="btn btn-sm"
      ...
      <div className="wholeleft">
        <div
          style={{
            width: breaking_point_desktop ? "50%" : "100%",
            overflowY: "scroll",
            height: breaking_point_desktop ? "83vh" : "94vh",
          }}
        >
          <div
            class="card"
            style={{
              width: "100%",
              boxShadow: breaking_point_desktop
                ? ""
                : "0px 1px 2px rgba(0, 0, 0, 0.12)",
              border: breaking_point_desktop ? "" : "none",
            }}
          >
            ...
            <div class="card-body">
              ...
              >
                ...
                I plan to reidf bsgakksa shly akssdjj shadkj
              </h6>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                {breaking_point_desktop ? (
                  <>
              ...
              <div style={{ display: "flex" }}>
                ...
                <p
                  style={{
                    fontSize: "14px",
                    color: "black",
                    width: breaking_point_desktop ? "" : "150px",
                    overflow: "hidden",
                    textOverflow: "ellipsis",
                    whiteSpace: "nowrap",
                  }}
            ...
            <div class="modal-body">
              ...
              >
                <div style={{ width: "50%" }}>
                  ...
                  />
                  <button
                    onClick={() => setUser_signed_in(true)}
                    data-bs-dismiss="modal"
                    style={{
                      height: "45px",
                      marginTop: "15px",
